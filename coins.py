parameters = {
    "http://aminoapps.com/c/LGBTFRIEND" 
}
...
class App:
    def __init__(self):
        self.client = Client()
        extensions = self.client.get_from_link(parameters["http://aminoapps.com/c/LGBTFRIEND"])["http://aminoapps.com/c/LGBTFRIEND"]["extensions"]
